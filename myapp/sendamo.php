...
//АВТОРИЗАЦИЯ
$user=array(
  'USER_LOGIN'=>'kmvsolar@gmail.com', #Ваш логин (электронная почта)
  'USER_HASH'=>'16e3f693d885fd2cdcf5874977bfc760ce3c1908' #Хэш для доступа к API (смотрите в профиле пользователя)
);
$subdomain='solarledcomua'; #Поддомен напирмер MYSHOP.amocrm.ru
